 ...
 */
public class TopMascotaActivityAdaptador extends RecyclerView.Adapter<TopMascotaActivityAdaptador.TopMascotaViewHolder>{

    private ArrayList<Mascota> mascotas;
    private Activity activity;

    public TopMascotaActivityAdaptador(ArrayList<Mascota> mascota, Activity activity) {
        this.mascotas = mascota;
        this.activity = activity;
    }

    @Override
    public TopMascotaViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final TopMascotaViewHolder holder, int position) {
